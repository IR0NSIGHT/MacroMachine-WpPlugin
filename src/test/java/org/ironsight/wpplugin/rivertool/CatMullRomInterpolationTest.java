...
class CatMullRomInterpolationTest {
    ...
    void prepareEmptyHandlesForInterpolation() {
        ...
        //only one is set
        incompleteHandles = new float[]{RiverHandleInformation.INHERIT_VALUE, RiverHandleInformation.INHERIT_VALUE, 7, RiverHandleInformation.INHERIT_VALUE, RiverHandleInformation.INHERIT_VALUE, RiverHandleInformation.INHERIT_VALUE};
        completeHandles = CatMullRomInterpolation.supplementFirstAndLastTwoHandles(incompleteHandles, RiverHandleInformation.INHERIT_VALUE,
                156f);
        expectedHandles = new float[]{7, 7, 7, RiverHandleInformation.INHERIT_VALUE, 7, 7};
        assertArrayEquals(expectedHandles, completeHandles);

        //two are set
        incompleteHandles = new float[]{5, RiverHandleInformation.INHERIT_VALUE, RiverHandleInformation.INHERIT_VALUE, RiverHandleInformation.INHERIT_VALUE, 7};
        completeHandles = CatMullRomInterpolation.supplementFirstAndLastTwoHandles(incompleteHandles, RiverHandleInformation.INHERIT_VALUE,
                156f);
        expectedHandles = new float[]{5, 5, RiverHandleInformation.INHERIT_VALUE, 7, 7};
        assertArrayEquals(expectedHandles, completeHandles);

        //two are set but in wierd positions
        incompleteHandles = new float[]{RiverHandleInformation.INHERIT_VALUE, 5, 7, RiverHandleInformation.INHERIT_VALUE, RiverHandleInformation.INHERIT_VALUE};
        completeHandles = CatMullRomInterpolation.supplementFirstAndLastTwoHandles(incompleteHandles, RiverHandleInformation.INHERIT_VALUE,
                156f);
        ...
        incompleteHandles = new float[]{RiverHandleInformation.INHERIT_VALUE, RiverHandleInformation.INHERIT_VALUE, 5, RiverHandleInformation.INHERIT_VALUE, 6, RiverHandleInformation.INHERIT_VALUE, 7,
                RiverHandleInformation.INHERIT_VALUE, 8, RiverHandleInformation.INHERIT_VALUE, 9, RiverHandleInformation.INHERIT_VALUE, 10, RiverHandleInformation.INHERIT_VALUE, RiverHandleInformation.INHERIT_VALUE};
        completeHandles = CatMullRomInterpolation.supplementFirstAndLastTwoHandles(incompleteHandles, RiverHandleInformation.INHERIT_VALUE,
                156f);
        expectedHandles = new float[]{5, 5, 5, RiverHandleInformation.INHERIT_VALUE, 6, RiverHandleInformation.INHERIT_VALUE, 7, RiverHandleInformation.INHERIT_VALUE, 8, RiverHandleInformation.INHERIT_VALUE, 9
                , RiverHandleInformation.INHERIT_VALUE, 10, 10, 10};
        assertArrayEquals(expectedHandles, completeHandles);


        {        //not a single value is known
            incompleteHandles = new float[]{RiverHandleInformation.INHERIT_VALUE, RiverHandleInformation.INHERIT_VALUE, RiverHandleInformation.INHERIT_VALUE, RiverHandleInformation.INHERIT_VALUE, RiverHandleInformation.INHERIT_VALUE
                    , RiverHandleInformation.INHERIT_VALUE};
            completeHandles = CatMullRomInterpolation.supplementFirstAndLastTwoHandles(incompleteHandles,
                    RiverHandleInformation.INHERIT_VALUE, 17.56f);
            expectedHandles = new float[]{17.56f, 17.56f, RiverHandleInformation.INHERIT_VALUE, RiverHandleInformation.INHERIT_VALUE, 17.56f, 17.56f};
            assertArrayEquals(expectedHandles, completeHandles);
        }

        {    //single set value
            incompleteHandles = new float[]{1, RiverHandleInformation.INHERIT_VALUE};
            completeHandles = CatMullRomInterpolation.supplementFirstAndLastTwoHandles(incompleteHandles,
                    RiverHandleInformation.INHERIT_VALUE, 17.56f);
        ...
        {    //no set value
            incompleteHandles = new float[]{RiverHandleInformation.INHERIT_VALUE};
            completeHandles = CatMullRomInterpolation.supplementFirstAndLastTwoHandles(incompleteHandles,
                    RiverHandleInformation.INHERIT_VALUE, 17.56f);
