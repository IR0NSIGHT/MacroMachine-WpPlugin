...
public class ActionResourceTest extends JerseyTest
{
    ...
    void testCreateAction() {
        ActionDTO dto = new ActionDTO(new MappingAction(new TerrainHeightIO(-64, 319), ActionFilterIO.instance,
        ...
        Response response = target("/actions").request().post(Entity.entity(dto, MediaType.APPLICATION_JSON));
