...
class ActionDTOTest {
    ...
    void fromToAction() {
        ...
        var dto = new ActionDTO(InputOutputDTO.fromInputGetter(input),
                InputOutputDTO.fromOutputSetter(output), ActionType.SET, "test action name",
                "test descriptions", UUID.randomUUID(), new int[]{0}, new int[]{52}, new int[]{52}, new int[]{0});
