...
class MacroTest
{
    ...
    void withReplacedUUIDs() {
        Macro initial = new Macro("Test", "descr",
    ...
    void applyMacroToDimension() {
        ...
        MappingAction setCyanAction = new MappingAction(new TerrainHeightIO(0, 255), new AnnotationSetter(),
                new MappingPoint[]{new MappingPoint(0, AnnotationSetter.ANNOTATION_ABSENT),
        ...
        Macro m = new Macro("paint cyan", "test", new UUID[]{setCyanAction.getUid()}, UUID.randomUUID(),
                new boolean[]{true});
        ...
        ApplyAction.ApplicationContext context = new ApplyAction.ApplicationContext(dim, macroContainer,
                actionContainer, TestData.getMockLayerProvider(), TestData.getMockLayerProvider(),
                new ActionFilterIO());
