...
class ContainerIOTest {
  ...
  public static final UUID complexMacroUID =
      UUID.fromString("e9462d29-bb6c-4eed-8d2f-23c3c9014b4b");
  public static final UUID applyGrassAction01 =
      UUID.fromString("8378edd5-88ab-4b8e-b274-c05a7c7713c4");
  public static final UUID applyGrassAction02 =
      UUID.fromString("77b21f11-d454-47f8-8085-cfd9bf9a9f4b");

  static MappingAction applyGrassEverywhere() {
    MappingAction action =
        MappingAction.getNewEmptyAction(UUID.fromString("ffaefa8c-08d2-4abb-ba81-4691eab57044"))
  ...
  static ExportContainer getContainerWithData() {
    ...
    ExportContainer container =
        new ExportContainer("2025-06-14-17-04", "no comment", macros, actions, new Layer[0]);
    return container;
  }
  ...
  public void exportActionWithLayerToFile() throws IOException {
    ...
    macroContainer.updateMapping(
        ...
        macroContainer
            .addMapping(macroId)
            .withName("paint pines macro")
            .withUUIDs(new UUID[] {actionId}));

    ExportContainer c =
        ContainerIO.toExportContainer(
            actionContainer,
            macroContainer,
            new ImportExportPolicy(),
            Assertions::fail,
