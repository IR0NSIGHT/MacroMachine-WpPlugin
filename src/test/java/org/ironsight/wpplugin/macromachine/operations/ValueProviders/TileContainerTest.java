...
class TileContainerTest
{
    ...
    @Test
    void setValueAt() {
        TileContainer container = new TileContainer(12000 / TILE_SIZE, 17000 / TILE_SIZE, -1000, -5555, 0);
    ...
    void getMinMaxXY() {
        int width = 93;
        int height = 132;
        TileContainer container = new TileContainer(width, height, -1000, -5555, 0);
