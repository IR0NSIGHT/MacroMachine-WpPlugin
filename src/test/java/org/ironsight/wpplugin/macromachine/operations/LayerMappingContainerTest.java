...
class LayerMappingContainerTest {
  ...
  @Test
  void updateMapping() {
    MappingActionContainer container =
        new MappingActionContainer(System.getProperty("user.dir") + "/TestActions" + ".json");
  ...
  void saveLoad() {
    ...
    MappingActionContainer newContainer =
        new MappingActionContainer(System.getProperty("user.dir") + "/TestActions" + ".json");
  ...
  void subscribe() {
    ...
    container.updateMapping(
        mapping.withNewPoints(new MappingPoint[] {new MappingPoint(10, 7)}), f -> {});
  ...
  void subscribeToMapping() {
    ...
    assertEquals(0, ran[0]);
    container.updateMapping(
        mapping.withNewPoints(new MappingPoint[] {new MappingPoint(1, 2)}), f -> {});
    assertEquals(1, ran[0]);
    container.deleteMapping(mapping.getUid());
    assertEquals(2, ran[0]);
