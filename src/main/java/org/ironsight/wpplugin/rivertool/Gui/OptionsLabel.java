...
public interface OptionsLabel {
  static OptionsLabel numericInput(
      String text,
      String tooltip,
      SpinnerNumberModel number,
      Consumer<Float> setOptionValue,
      Runnable notifyAfterReconfigure) {
            ...
            return new JFormattedTextField.AbstractFormatter() {
              ...
              public String valueToString(Object value) throws ParseException {
                if (value instanceof Double) {
                  ...
                  if (val == RiverHandleInformation.INHERIT_VALUE) return "INHERIT";
