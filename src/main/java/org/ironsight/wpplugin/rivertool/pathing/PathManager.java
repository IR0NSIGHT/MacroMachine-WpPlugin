...
public class PathManager {
  ...
  public PathManager() {
    ...
    addPath(
        new Path(
            Arrays.asList(
                RiverHandleInformation.riverInformation(i * -1 - 50, i),
                ...
                RiverHandleInformation.riverInformation(
                    i * 3, i, 7, 4, 10, 0, RiverHandleInformation.INHERIT_VALUE),
                RiverHandleInformation.riverInformation(i * 3 + 50, i)),
            PointType.RIVER_2D));
  }
  ...
  public static class NamedId {
    ...
    public NamedId(int id, String name, PointType type) {
      this.id = id;
      this.type = type;
      this.name = name;
    }
