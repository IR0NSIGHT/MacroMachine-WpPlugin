...
public class PointType {
  public static final PointType POSITION_2D =
      new PointType(new RiverHandleInformation.RiverInformation[0], 2);
  public static final PointType RIVER_2D =
      new PointType(RiverHandleInformation.RiverInformation.RIVER_INFORMATIONS, 2);
