...
public class ArrayUtility {
  ...
  /**
   * will take original array + marker array and combine marked indices with the previous ones. all
   * marked positions will be removed unmarked positions gain the sum of marked values following it
