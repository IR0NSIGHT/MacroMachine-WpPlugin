...
public class RiverHandleInformation {
  ...
  public static float[] riverInformation(int x, int y) {
    return riverInformation(
        x, y, INHERIT_VALUE, INHERIT_VALUE, INHERIT_VALUE, INHERIT_VALUE, INHERIT_VALUE);
  }

  public static float[] riverInformation(
      int x,
      int y,
      float riverRadius,
      float riverDepth,
  ...
  public static float[] positionInformation(float x, float y, PointType type) {
  ...
  public static boolean validateRiver2D(ArrayList<float[]> handles) {
    for (float[] handle : handles) {
      ...
      for (RiverInformation information : RIVER_INFORMATIONS) {
  ...
  public static JDialog riverRadiusEditor(
      JFrame parent,
      Path path,
  ...
  public static OptionsLabel[] Editor(
      float[] point, Consumer<float[]> onSubmitCallback, Runnable onChanged) {
    OptionsLabel[] options = new OptionsLabel[RIVER_INFORMATIONS.length];
    int i = 0;
    for (RiverInformation information : RIVER_INFORMATIONS) {
      SpinnerNumberModel model =
          new SpinnerNumberModel(
              getValue(point, information), information.min - 1, information.max, 1f);
  ...
  public static void DrawRiverPath(Path path, ContinuousCurve curve, PaintDimension dim)
    ...
    for (int i = 1; i < curve.curveLength() - 1; i++) {
      ...
      for (RiverInformation info : new RiverInformation[] {RIVER_RADIUS}) {
  ...
  public static float sanitizeInput(float input, RiverInformation information) {
    if (input < information.min) return INHERIT_VALUE;
  ...
  public interface InterpolatableInformation {
    int getIndex();
  ...
  public static class RiverInformation {
    ...
    public static final RiverInformation RIVER_RADIUS =
        new RiverInformation(0, "river radius", "radius of the river ", 0, 1000);
    public static final RiverInformation RIVER_DEPTH =
        new RiverInformation(1, "river depth", "depth of the" + " river ", 0, 1000);
    public static final RiverInformation BEACH_RADIUS =
        new RiverInformation(2, "beach radius", "radius of the beach ", 0, 1000);
    public static final RiverInformation TRANSITION_RADIUS =
        new RiverInformation(
            3,
            "transition radius",
            "radius of the transition blending with original terrain ",
            0,
            1000);
    public static final RiverInformation WATER_Z =
        new RiverInformation(4, "water level", "water level position on z axis", -10000, 100000);
    public static final RiverInformation[] RIVER_INFORMATIONS =
        new RiverInformation[] {
          RIVER_RADIUS, RIVER_DEPTH, BEACH_RADIUS, TRANSITION_RADIUS, WATER_Z
        };
    ...
    public RiverInformation(int idx, String displayName, String toolTip, float min, float max) {
      this.min = min;
      this.max = max;
