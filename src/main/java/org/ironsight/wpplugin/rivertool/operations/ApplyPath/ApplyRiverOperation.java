...
public class ApplyRiverOperation extends MouseOrTabletOperation
{
    ...
    public static void applyRiverPath(Path path, ApplyPathOptions options, HeightDimension dimension,
        ...
        double totalSearchRadius = RiverHandleInformation.getValue(maxHandleValues,
                RiverHandleInformation.RiverInformation.RIVER_RADIUS)
                + RiverHandleInformation.getValue(maxHandleValues,
                        RiverHandleInformation.RiverInformation.BEACH_RADIUS);
        ...
        for (int curveIdx = 0; curveIdx < curve.curveLength(); curveIdx++) {
            ...
            double riverRadius = curve.getInfo(RiverHandleInformation.RiverInformation.RIVER_RADIUS, curveIdx)
        ...
        float maxTransition = (RiverHandleInformation.getValue(maxHandleValues,
                RiverHandleInformation.RiverInformation.TRANSITION_RADIUS));
    ...
    private static class ApplyPathOptionsPanel extends OperationOptionsPanel<ApplyPathOptions>
    {
        ...
        protected ArrayList<OptionsLabel> addComponents(ApplyPathOptions options, Runnable onOptionsReconfigured) {
            ...
            inputs.add(OptionsLabel.numericInput("random width",
            ...
            inputs.add(OptionsLabel.numericInput("fluctuation speed",
