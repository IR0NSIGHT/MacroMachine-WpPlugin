...
public class HandleAndIdcs {
  ...
  public HandleAndIdcs(
      float[] positions, int[] idcs, float[] segmentLengths, float[] handleStrengths) {
  ...
  public static HandleAndIdcs removeInheritValues(HandleAndIdcs struct) {
    ...
    float[] newHandleStrengths =
        ArrayUtility.removePositions(struct.handleStrengths, removeMarkers);
    HandleAndIdcs out =
        new HandleAndIdcs(newPositions, newHandleToCurve, newSegmentLengths, newHandleStrengths);
