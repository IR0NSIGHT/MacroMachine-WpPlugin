...
public class MacroSelectionLayer extends Layer {
   ...
   * the distanceToEdge function provided by worldpainter can only search inside of bit layers, and
   * selection is split into SelectionBlock and SelecctionChunk which messes up the result. so this
   * is a single-layer-paintable-selection substitute.
   */
