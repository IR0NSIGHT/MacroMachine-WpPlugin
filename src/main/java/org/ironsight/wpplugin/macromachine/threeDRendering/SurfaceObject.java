...
public class SurfaceObject implements WPObject
{
    ...
    private float[][] height = new float[][]{new float[]{62, 63, 64, 65, 66}, new float[]{62, 63, 64, 65, 66},
            new float[]{62, 63, 64, 65, 66}, new float[]{62, 63, 64, 65, 66},};
    private float[][] waterheight = new float[][]{new float[]{64, 64, 64, 64, 64}, new float[]{64, 64, 64, 64, 64},
            new float[]{64, 64, 64, 64, 64}, new float[]{64, 64, 64, 64, 64},};
    Material[][] terrain = new Material[][]{
            new Material[]{Material.GRASS_BLOCK, Material.GRASS_BLOCK, Material.GRASS_BLOCK, Material.GRASS_BLOCK,
