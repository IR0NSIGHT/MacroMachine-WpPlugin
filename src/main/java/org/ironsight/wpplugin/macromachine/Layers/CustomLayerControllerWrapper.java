...
/**
 * API to worldpainters CustomLayerController, that manages all custom layers use to get proper list
 * of customlayers avaialble in WP use to register new custom layers to WP
 */
public class CustomLayerControllerWrapper implements LayerProvider {
  ...
  private CustomLayerController getCustomLayerController() {
    ...
    try {
      ...
      Field customLayerControllerField =
          appInstance.getClass().getDeclaredField("customLayerController");
  ...
  public void addLayer(Layer layer) {
    ...
    try {
      ...
      Method registerMethod =
          appClass.getDeclaredMethod("registerCustomLayer", CustomLayer.class, boolean.class);
