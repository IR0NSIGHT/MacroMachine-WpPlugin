...
public class ActionJsonWrapper {
  ...
  public ActionJsonWrapper(MappingAction mapping) {
    ...
    int[] ins = new int[mapping.getMappingPoints().length],
        outs = new int[mapping.getMappingPoints().length];
    int i = 0;
  ...
  public boolean equals(Object o) {
    ...
    return getInputId() == that.getInputId()
        && Arrays.equals(getInputData(), that.getInputData())
        && getOutputId() == that.getOutputId()
        && Arrays.equals(getOutputData(), that.getOutputData())
  ...
  public int hashCode() {
    int result =
        Objects.hash(
            getInputId(), getOutputId(), getActionType(), getName(), getDescription(), getUid());
