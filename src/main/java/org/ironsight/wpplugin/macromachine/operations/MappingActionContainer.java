...
/**
 * this class stores MappingActions by UUID it can read and write to file its the central authority
 * on which action exist. if its not in the container, its considered non-existent.
 */
public class MappingActionContainer extends AbstractOperationContainer<MappingAction> {
  ...
  public MappingActionContainer(String filePath) {
    super(
        MappingAction.class,
        filePath == null ? getActionsFilePath() : filePath,
        "/DefaultActions.json");
  }
  ...
  public static void addDefaultMappings(MappingActionContainer container) {
    ...
    m =
        new MappingAction(
            ...
            ActionType.SET,
            "paint mountainsides",
            "apply stone and rocks "
                + "based"
                + " on slope to make mountain sides colorful and interesting",
            m.getUid());
    ...
    m =
        new MappingAction(
            ...
            new MappingPoint[] {
              new MappingPoint(0, 15), new MappingPoint(70, 15), new MappingPoint(80, 0)
            },
            ActionType.LIMIT_TO,
            "no steep pines",
