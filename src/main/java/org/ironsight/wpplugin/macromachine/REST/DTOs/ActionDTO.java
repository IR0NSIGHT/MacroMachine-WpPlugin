...
public class ActionDTO {
  ...
  public ActionDTO(MappingAction action) {
    this(
        InputOutputDTO.fromInputGetter(action.getInput()),
        InputOutputDTO.fromOutputSetter(action.getOutput()),
  ...
  @JsonCreator
  public ActionDTO(
      @JsonProperty("input") InputOutputDTO input,
      @JsonProperty("output") InputOutputDTO output,
      @JsonProperty("actionType") ActionType actionType,
      @JsonProperty("name") String name,
      @JsonProperty("description") String description,
      @JsonProperty("uid") UUID uid,
      @JsonProperty("mappingPointsX") int[] mappingPointsX,
      @JsonProperty("mappingPointsY") int[] mappingPointsY,
      @JsonProperty("mappedOutputs") int[] mappedOutputs,
      @JsonProperty("mappedInputs") int[] mappedInputs) {
    this.input = input;
    this.output = output;
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(getInput(), actionDTO.getInput())
        && Objects.equals(getOutput(), actionDTO.getOutput())
        && getActionType() == actionDTO.getActionType()
  ...
  public int hashCode() {
    int result =
        Objects.hash(
            getInput(), getOutput(), getActionType(), getName(), getDescription(), getUid());
  ...
  public MappingAction toAction() {
    ...
    return new MappingAction(
        input.toGetter(), output.toSetter(), mappingPoints, actionType, name, description, uid);
  }
  ...
  public String toString() {
    return "ActionDTO{"
        ...
        + uid
        + ", mappingPointsX="
        + Arrays.toString(mappingPointsX)
        + ", mappingPointsY="
        + Arrays.toString(mappingPointsY)
        + ", mappedInputs="
