...
public class ExecutionResource
{
    ...
    public ExecutionResource(MacroApplicator applicator, MappingActionContainer actions, MacroContainer macros) {
    ...
    public ExecutionQueueDTO addToQueue(@Valid ExecutionQueueDTO request) {
        ...
        for (var uid : existingMacros)
            applicator.queueMacro(uid);
        return new ExecutionQueueDTO(applicator.getQueue());
    }
}
