...
public class MacroDTO
{
    ...
    @JsonCreator
    public MacroDTO(@JsonProperty("executionUUIDs") UUID[] executionUUIDs,
            @JsonProperty("activeActions") boolean[] activeActions, @JsonProperty("name") String name,
    ...
    public MacroDTO(Macro macro) {
        this(macro.executionUUIDs, macro.getActiveActions(), macro.getName(), macro.getDescription(), macro.getUid());
    }
