...
public class RangeTableEditor extends LayerMappingPanel {
    ...
    { // prepare main body components
      { // table
        ...
        table.setDefaultEditor(
            MappingPointValue.class, new MappingPointCellEditor(new int[] {0, 1}));
  ...
  public static String Explain(
      MappingPointValue inputStart,
      MappingPointValue inputEnd,
      MappingPointValue output,
  ...
  public static void main(String[] args) {
    ...
    var SlopeTerrain =
        new MappingAction(
            ...
            new TerrainProvider(),
            new MappingPoint[] {
              new MappingPoint(30, Terrain.GRASS.ordinal()),
