...
public class MappingPointCellEditor implements TableCellEditor {
  ...
  private final FocusListener onDropdownFocusLost =
      new FocusListener() {
        @Override
  ...
  public Component getTableCellEditorComponent(
      JTable table, Object value, boolean isSelected, int viewRow, int viewColumn) {
    assert value != null;
    ...
    SwingUtilities.invokeLater(
        () -> {
          if (dropdown.requestFocusInWindow()) dropdown.showPopup();
        });
  ...
  private PopupMenuListener onComboboxSelected =
