...
public class ActionDesigner extends LayerMappingPanel {
  ...
  public static void main(String[] args) {
    ...
    MappingAction ma =
        new MappingAction(
            ...
            ActionType.SET,
            "Blue annotation perlin blobs",
            "Create perlin islands with annotation blue",
            UUID.randomUUID());
    ...
    var OceanHeight =
        new MappingAction(
            ...
            setter,
            new MappingPoint[] {
              new MappingPoint(0 /* ocean */, 31), new MappingPoint(1, IGNORE_VALUE)
            },
            ActionType.LIMIT_TO,
            "No pines in the ocean",
            "xx",
            UUID.randomUUID());
  ...
  protected void initComponents() {
    ...
    submitButtom.setToolTipText(
        "Submit action and save to global list. Use ctrl + S as a shortcut.");
    ...
    buttonPanel.add(
        getHelpButton(
            ...
            "Use the Action editor the define what your action does.\n"
                ...
                + "8, then "
                + "all blocks with 45° slope will "
                + "receive pine level 8 when the action is executed.\n"
