...
export const Default: Story = {
  render: () => (
    <MappingPointEditorWrapper oldPoint={{ x: 3, y: 50, input: annotationsIO, output: heightIO }} />
  ),
};
...
export const NewPoint: Story = {
  render: () => (
    <MappingPointEditorWrapper
      oldPoint={{ x: 3, y: 50, input: perlinNoiseIO, output: terrainIO }}
    />
  ),
};
